"""
Django settings for beijing_roast_duck_45383 project.
...
ROOT_URLCONF = 'beijing_roast_duck_45383.urls'
...
WSGI_APPLICATION = 'beijing_roast_duck_45383.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "beijing_roast_duck_45383 API",
    "DESCRIPTION": "API documentation for beijing_roast_duck_45383 App",
    "VERSION": "v1",
}
